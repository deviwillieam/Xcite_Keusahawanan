...
use Vanguard\Http\Controllers\Web\StudentRegistrationController;
...
// Display the registration form and list of groups
Route::resource('student-registration', StudentRegistrationController::class);

//List of startups
Route::resource('list-startups', ListStartupsController::class);
// Route::get('student-registration', [StudentRegistrationController::class, 'index'])->name('student-registration.index');

// // Handle the registration form submission
// Route::post('student-registration', [StudentRegistrationController::class, 'store'])->name('student-registration.store');

// // Route to delete a registration
// Route::delete('student-registration/{id}', [StudentRegistrationController::class, 'destroy'])->name('student-registration.destroy');
/**
 * Authentication
 */
